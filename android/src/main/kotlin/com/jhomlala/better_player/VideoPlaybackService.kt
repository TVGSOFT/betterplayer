...
open class VideoPlaybackService : MediaLibraryService() {

  private lateinit var mediaLibrarySession: MediaLibrarySession

  companion object {
    private const val NOTIFICATION_ID = 123
    private const val CHANNEL_ID = "video_player_session_notification_channel_id"
  }
   ...
   * an alternative callback, for example a subclass of [VideoMediaLibrarySessionCallback].
   *
   * This method is called when the session is built by the [VideoPlaybackService].
   */
  protected open fun createLibrarySessionCallback(): MediaLibrarySession.Callback {
    return VideoMediaLibrarySessionCallback(this)
  }
  ...
  private inner class MediaSessionServiceListener : Listener {
    ...
    override fun onForegroundServiceStartNotAllowedException() {
      ...
      val builder =
        NotificationCompat.Builder(this@VideoPlaybackService, CHANNEL_ID)
